...
class Disket(models.Model):
    ...
    visibility = models.CharField(max_length=10, choices=Visibility.choices, help_text=_("The visibility of the disket"), verbose_name=_("Visibility"))
    zip_file = models.FileField(upload_to='uploads/', help_text=_("The zip file of the disket"), verbose_name=_("Zip File"))
    created_at = models.DateTimeField(auto_now_add=True, help_text=_("The date and time the disket was created"), verbose_name=_("Created At"))
    approved = models.BooleanField(default=False, help_text=_("Whether the disket has been approved"), verbose_name=_("Approved"))
    content_path = models.CharField(max_length=255, blank=True, help_text=_("The path to the content of the disket"), verbose_name=_("Content Path"))
...
class DisketVersion(models.Model):
    disket = models.ForeignKey(Disket, on_delete=models.CASCADE, verbose_name=_("Disket"))
    log = models.CharField(max_length=255, help_text=_("The log of the disket version"), null=True, blank=True, verbose_name=_("Log"))
